# -*- coding: utf-8 -*-
"""
Created on Fri May  5 23:17:31 2017
...
features = [frame[FEATURE_NAMES].shift(3).rolling(window=3,center=False).mean()[6:] for frame in data]
...
for i in range(2):    
    ...
    clf = MLPRegressor(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(100,20), random_state=1)
